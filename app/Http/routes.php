...
Route::group(['prefix' => 'lessons', 'as' => 'lessons.'], function () {
	...
	Route::group(['prefix' => 'single', 'as' => 'single.'], function () {
		...
		Route::any('/{id}/edit', ['as' => 'update', 'uses' => 'LessonsController@updateSingle']);
		Route::get('/{id}/delete', ['as' => 'delete', 'uses' => 'LessonsController@deleteSingle']);
		Route::get('/download', ['as' => 'singleToPdf', 'uses' => 'LessonsController@singleToPdf']);
	});
});

Route::group(['prefix' => 'load', 'as' => 'load.'], function () {
	Route::get('/', ['as' => 'planned', 'uses' => 'LoadController@planned']);
	Route::get('/passed', ['as' => 'passed', 'uses' => 'LoadController@passed']);
